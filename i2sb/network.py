...
from guided_diffusion.script_util import create_model,model_and_diffusion_defaults_64
...
class Image64Net(torch.nn.Module):
    def __init__(self, log, noise_levels, use_fp16=False, cond=False, pretrained_adm=True, ckpt_dir="data/"):
        super(Image64Net, self).__init__()
        ...
        self.diffusion_model = create_model(**model_and_diffusion_defaults_64())
        log.info(f"[Net] Initialized network from start ! Size={util.count_parameters(self.diffusion_model)}!")
